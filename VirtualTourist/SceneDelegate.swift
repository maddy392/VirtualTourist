...
//        let initialLocation = CLLocationCoordinate2D(latitude: 40.7128, longitude: -74.0060) // Coordinates for Paris, France
//        let regionRadius: CLLocationDistance = 10000 // Distance in meters
//        let coordinateRegion = MKCoordinateRegion(center: initialLocation,
//                                                  latitudinalMeters: regionRadius,
//                                                  longitudinalMeters: regionRadius)
//        travelLocationsViewController.mapView.setRegion(coordinateRegion, animated: true)
        }
